...
describe CompaniesController do
  ...
  describe "direct company access" do
  	...
  	describe "route generation" do
		  ...
		  it "should map { :controller => 'companies', :action => 'edit' } to /empresas/1/ver" do
		    route_for(:controller => "companies", :action => "edit").should == "/empresas/1/ver"
		  end
		  it "should map { :controller => 'companies', :action => 'udpate', :id => 1 } to /empresas/1" do
		    route_for(:controller => "companies", :action => "udpate").should == "/empresas/1"
		  end
		  it "should map { :controller => 'companies', :action => 'destroy' } to /empresas/1" do
		    route_for(:controller => "companies", :action => "destroy").should == "/empresas/1"
		  end
  	end
	...
	describe "acessing user companies" do
		...
		describe "route generation" do
			...
			it "should map { :controller => 'companies', :action => 'show', :id => 1, :user_id => '1' } to /usuarios/1/empresas/1" do
				route_for(:controller => "companies", :action => "index", :id => 1, :user_id => "1").should == "/usuarios/1/empresas/1"
			end
			it "should map { :controller => 'companies', :action => 'edit', :id => 1 :user_id => '1' } to /usuarios/1/empresas/1/ver" do
				route_for(:controller => "companies", :action => "index", :id => :user_id => "1").should == "/usuarios/1/empresas/1/ver"
			end
		...
		describe "route recognition" do
			...
			it "should generate params { :controller => 'companies', :action => 'edit', :id => 1, :user_id => '1' } from GET /usuarios/1/empresas/1/ver" do
			...
			it "should generate params { :controller => 'companies', :action => 'update', :id => 1, :user_id => '1' } from PUT /usuarios/1/empresas/1" do
				params_from(:get, "/usuarios/1/empresas/1").should == { :controller => "companies", :action => "udpate", :id => 1, :user_id => '1' }
			end
			it "should generate params { :controller => 'companies', :action => 'destroy', :id => 1, :user_id => '1' } from DELETE /usuarios/1/empresas/1" do
				params_from(:get, "/usuarios/1/empresas/1").should == { :controller => "companies", :action => "destroy", :id => 1, :user_id => '1' }
			end
		end
